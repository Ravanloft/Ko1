...
public:
	...
	virtual tstring GetColumns() { return _T("ZoneID, NpcID, ActType, RegenType, DungeonFamily, SpecialType, TrapNumber, LeftX, TopZ, RightX, BottomZ, LimitMinX, LimitMinZ, LimitMaxX, LimitMaxZ, NumNPC, RegTime, byDirection, DotCnt, path, Room,Cember"); }
	...
	virtual bool Fetch()
	{
		...
		_dbCommand->FetchByte(22, pData->isInCember);
