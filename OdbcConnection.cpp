...
OdbcConnection::OdbcConnection() : m_connHandle(nullptr), m_envHandle(nullptr), m_bMarsEnabled(false), m_lock(new boost::recursive_mutex()){}
...
bool OdbcConnection::DB_Connect()
{
	m_szDSN = "CyberACS";
	m_szUser = "";
	m_szPass = "";
